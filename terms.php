<?php
$pageTitle = "Terms & Conditions — Cheap Flights US";
$pageDesc  = "Terms and Conditions of Cheap Flights US. Read the legal guidelines and booking rules governing your use of our website.";
...
<section class="bg-gradient-to-br from-navy via-slate-900 to-sky-900 text-white py-14 relative overflow-hidden">
  <div class="max-w-7xl mx-auto px-4 relative z-10 text-center">
    ...
    <p class="text-sky-200 text-base md:text-lg max-w-2xl mx-auto">Important Information About Using Cheap Flights US Travel Services.</p>
...
<section class="py-14">
  <div class="max-w-4xl mx-auto px-4 bg-white p-8 md:p-12 rounded-3xl border border-slate-200 shadow-sm space-y-8 text-slate-700 text-sm leading-relaxed">
    ...
    <div>
      <h2 class="text-2xl font-black text-navy mb-3">Cheap Flights US Terms &amp; Conditions Agreement</h2>
      <p class="text-slate-600">
        <strong>cheapflightsus.com</strong> is an internet travel portal aimed specifically to fulfill customer requirements for planning flight itineraries across the world. When utilizing the Website for any travel requirements, you agree to follow the terms and conditions outlined herein. The terms apply to all travel transactions made through the portal in accordance with legal requirements.
      </p>
    </div>
    ...
    <div>
      ...
      <p class="text-slate-600">
        Tickets purchased on Cheap Flights US are bound by airline carriage contracts. Fares display in US Dollars (USD). Airlines retain full rights to alter schedules or operate code-share flights. Taxes, airport fees, and service charges apply. Requests for seats, meals, or frequent flyer points are subject to airline approval.
      </p>
    </div>
    ...
    <div>
      ...
      <p class="text-slate-600">
        All payments are charged in USD. If your credit or debit card is issued outside the US, your card provider may apply currency conversion rates or foreign transaction fees over which Cheap Flights US has no control.
      </p>
    </div>
    ...
    <div>
      ...
      <p class="text-slate-600">
        The Website and services are provided "as is" and "as available". Cheap Flights US shall not be liable for flight delays, mechanical issues, weather cancellations, or server connection interruptions beyond our reasonable control.
      </p>
    </div>
